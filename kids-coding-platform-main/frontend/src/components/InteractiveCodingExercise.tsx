        ...
        <div className="flex justify-between items-start mb-4">
          <div>
            ...
            <div className="flex gap-2 mt-2">
              <span className={`px-2 py-1 rounded-full text-xs font-medium ${currentExercise.difficulty === 'beginner' ? 'bg-green-100 text-green-600' :
          ...
          <div className="border-t border-gray-200 pt-4">
            ...
            <div className="space-y-2">
              {currentExercise.steps.map((step, index) => (
                <div
                  key={step.id}
                  className={`flex items-center gap-2 p-2 rounded-lg transition-colors cursor-pointer ${index === currentStepIndex ? 'bg-blue-50 border border-blue-200' :
                ...
                >
                  ...
                  <span className={`text-sm ${index === currentStepIndex ? 'font-semibold text-blue-700' :
